...
# Text below will populate the StartTile variable intro-text
        return """
********************************************************************************
Welcome to Choice City--the gateway to Enlightenment.  The streets of Choice\n 
City are filled what you would expect given the name, Choices.  These Choices as\n 
well as the ability to learn from your expierences will be critical to the sucess\n
of your journey.
********************************************************************************
...
*******************************************************
         ...
         ***********************************************************************
         ...
         """
            self.dead_text =  """
         ********************************************************************************   
         *   The wolves proved to be stronger than you thought.  You were not able to    *
         *   reach the the Magical Forest on the other side of the City.  Learning from  *
         *   your mistakes will put your on the fast track to Enlightenment and if you   *
         *   can apply thesel lessons in your next life you be more likely to suceed.    *                                                     ********************************************************************************
...
"""
     ...
     * is right. Respecting other's beliefs even when they go against your own may not easy but    *
     * hey!, Do you want to be right or happy? The choice is yours.                                *
     * *********************************************************************************************
"""
            self.dead_text= """ 
             ******************************************************************************
...
"""
         ...
         *********************************************************************************
         *  You feel the wind pick up and you are suddenly lost in swarm of bommerangs!  *
         *  You quickly notice that these are not your average everyday boomerangs but   * 
         *  instead one's that you threw in the distant past.  Everyone has a past or a  * 
         *  history of Choices and if this has happend to you while on your journey      *
         *  through the city take a breath and deal with your karma now because by it's  * 
         *  very nature it's not coming back to or for you.  Hopefully the former!"      *
         *********************************************************************************
"""
            self.dead_text =  """
                 ************************************************************************** 
...
You feel the wind pick up and you are suddenlylost in swarm of bommerangs!  
You quickly notice that these are not your average everyday boomerangs but 
instead one's that you threw in the distant past.  Everyone has a past or 
a history of Choices and if this has happend to you while on your journey 
through the city take a breath and deal with your karma now because by 
it's very nature it's not coming back to or for you. Hopefully the former!
"""

           self.dead_text =  """
           Dozens of boomerangs have hit your and knocked you to the ground.  Look on the 
           bright side you were able to settle an recent or age old karmatic debt.
           'There is such thing as good or bad, right or wrong, those are perspectives of
